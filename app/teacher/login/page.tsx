    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-400 via-teal-500 to-cyan-600 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-black text-white mb-4 drop-shadow-2xl tracking-tight">Portal Guru TPQ</h1>
          <div className="inline-block">
            <p className="text-emerald-50 text-lg md:text-xl font-bold mb-2">Masuk untuk melihat performa Anda</p>
            <div className="h-1 w-24 bg-white bg-opacity-40 rounded-full mx-auto"></div>
          </div>
        </div>
