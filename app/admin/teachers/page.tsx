    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Password Portal Guru *</label>
            <input
              type="password"
              ...
              minLength={6}
            />
            <p className="text-xs text-gray-500 mt-1">Password ini digunakan pengajar untuk masuk ke Portal Guru dan mengelola kelas</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-t pt-4">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Ubah Password Portal Guru
              <span className="text-gray-500 font-normal ml-2">(Kosongkan jika tidak ingin mengubah)</span>
            </label>
            <input
              type="password"
              value={(formData as any).new_password || ''}
              onChange={(e) => setFormData(prev => ({ ...prev, new_password: e.target.value }))}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
              placeholder="Masukkan password baru (min 6 karakter)"
              minLength={6}
            />
            <p className="text-xs text-gray-500 mt-1">Password minimal 6 karakter. Password ini digunakan guru untuk masuk ke Portal Guru.</p>
          </div>
