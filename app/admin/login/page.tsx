        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 backdrop-blur-sm bg-opacity-95">
          ...
          <div className="mt-6 text-center space-y-3">
            ...
            <div className="border-t pt-3">
              <p className="text-sm text-gray-600 mb-2">Login sebagai pengajar?</p>
              <Link 
                href="/teacher/login" 
                className="inline-flex items-center justify-center w-full py-2 px-4 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-lg font-medium text-sm transition-all duration-300 hover:shadow-md"
              >
