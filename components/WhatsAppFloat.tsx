...
export default function WhatsAppFloat() {
  ...
  const handleWhatsAppClick = () => {
    ...
    // Remove leading zeros and country code if exists
    let phone = settings.whatsapp.replace(/^0+/, '');
    if (!phone.startsWith('62')) {
      phone = '62' + phone;
    }
    
    const message = encodeURIComponent(settings.whatsapp_message || 'Assalamu\'alaikum, saya ingin bertanya tentang TPQ');
